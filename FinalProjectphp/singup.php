...
<body>
	...
	<main> 
		...
		<div class="loginDiv"> <!--singup card-->
			<img class="avatar" src="logo.png" alt="logoLoginCard">
			<h1>SingUp</h1>
			<form method="POST" action="guardar.php">
				<label for="name">Nombre</label>
				<input type="text" name="nombre" placeholder="Nombre" required> <!--name input-->

				<label for="apellido">Apellido</label>
				<input type="text" name="apellido" placeholder="apellido" required> <!--name input-->

				<label for="email">Email</label>
				<input type="email" name="email" placeholder="Email" required> <!--email input-->

				<label for="password">Contraseña</label>
				<input type="password" name="password" placeholder="Contraseña" required> <!--password input-->
